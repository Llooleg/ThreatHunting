...
```
    ...
    loaded via a namespace (and not attached):
     ...
     [5] htmltools_0.5.8.1 yaml_2.3.10       rmarkdown_2.30    knitr_1.48       
     [9] jsonlite_2.0.0    xfun_0.48         digest_0.6.37     rlang_1.1.4      
    [13] evaluate_1.0.1   
...
Ссылка на [итоговый дашборд](https://datalens.ru/9tag1ejh87fqt)
